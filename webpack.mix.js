...
/*
 ...
 |--------------------------------------------------------------------------
 |
 | O Mix fornece uma API limpa e fluente para definir algumas etapas de construção do Webpack
 | para o seu aplicativo Laravel. Por padrão, estamos compilando o Sass
 | arquivo para o aplicativo, bem como agrupar todos os arquivos JS.
 | informar a origim do arquivo depois o destino e rodar o comando:
 | npm install dependência do node presente no arquivo package.json
 | npm run dev
 */
